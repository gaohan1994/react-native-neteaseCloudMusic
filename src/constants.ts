...
export const RECEIVE_CURRENT_COMMENTS = 'RECEIVE_CURRENT_COMMENTS';
export type RECEIVE_CURRENT_COMMENTS = typeof RECEIVE_CURRENT_COMMENTS;

export const RECEIVE_COLLECTION_LIST = 'RECEIVE_COLLECTION_LIST';
export type RECEIVE_COLLECTION_LIST = typeof RECEIVE_COLLECTION_LIST;