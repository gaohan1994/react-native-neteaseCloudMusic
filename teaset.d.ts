...
import { TouchableOpacityProps, View, ViewProperties, TextStyle, TouchableOpacity } from 'react-native';
...
export class SwipeActionButton extends React.Component<SwipeActionButtonProps> {
